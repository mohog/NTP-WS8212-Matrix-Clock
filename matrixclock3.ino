//This version the bottom line of leds shows passing of seconds, current led dims as next is illuminated, two total fads before black every 1/24th of a minute
